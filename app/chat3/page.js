...
/* ─── 이미지 헬퍼: chatUtils.js에서 공유 유틸리티 임포트 ─── */
import {
  generateImageId,
  readFileAsDataUrl,
  formatSize,
...
export default function Chat3Page() {
  ...
  /* ─── 이펙트: 인증·IP·설정·모델복원·이미지초기화·포커스·스크롤·IntersectionObserver
     는 useChatPage()에서 처리됨. 아래는 chat3 전용 이펙트만 유지. ─── */
